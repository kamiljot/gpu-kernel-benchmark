...
__global__ void add_global_kernel(const float* in1, const float* in2, float* out, size_t size)
{
...
extern "C" void launch_cuda_add_global(float* in1, float* in2, float* out, size_t size)
{
    int threads = 256;
